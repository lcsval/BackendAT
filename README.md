...
O fluxo para obter as listas de músicas pela cidade/latitude/longitude seria: 
...
3. Para garantir o funcionamento, sempre estou gerando um novo token do spotify para o app backend em cada requisição para a api (os dados estão no appsettings.js da pasta Backend.Api)
4. O CommandHandler retorna o resultado da requisição api (lista de strings com o nome das músicas)
...
1. Dentro de Backend.Api rodar dotnet publish -o ./dist para publicar
